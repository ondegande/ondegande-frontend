    ...
    <div className="feature__explain column a-center gap-16">
      ...
      <div className="features grid-2 gap-28">
        <div className="feature column j-space-between gap-40 br-12 cursor">
          ...
          <p className="f-16 w-400 c-555555">나만의 여행 코스를 직접 만들고 공유</p>
          <div className="feature__button f-16 c-155dfc">자세히 보기 →</div>
        </div>
        <div className="feature column j-space-between gap-40 br-12 cursor">
          ...
          <p className="f-16 w-400 c-555555">내 위치 기반 주변 맛집, 관광지, 숙소 추천</p>
          <div className="feature__button f-16 c-155dfc">자세히 보기 →</div>
        </div>
        <div className="feature column j-space-between gap-40 br-12 cursor">
          ...
          <p className="f-16 w-400 c-555555">부산 테마별 추천 여행 코스 모음</p>
          <div className="feature__button f-16 c-155dfc">자세히 보기 →</div>
        </div>
        <div className="feature column j-space-between gap-40 br-12 cursor">
          ...
          <p className="f-16 w-400 c-555555">유튜버들이 방문한 코스와 영상 정보</p>
          <div className="feature__button f-16 c-155dfc">자세히 보기 →</div>
        </div>
      </div>
    </div>
