...
function GoThis() {
  ...
  const themes = ["전체", "레저", "맛", "휠체어", "문화", "반려동물", "역사", "연예인", "힐링"];
    ...
    <div>
      <main>
        <section className="GTup-section">
          <section className="busanmap-section"></section>
          ...
          <section className="maptheme-section">
            ...
            <div className="submit-button-container">
              ...
              <button className="submit-button" onClick={handleRandomCourse}>
                랜덤 코스
              </button>
            </div>
          </section>
        ...
        <section className="mapthemecourse-section">
          <div className="results-container">
            ...
            {!loading && results.length === 0 && !error && (
              <p className="no-results-message">원하는 지역 및 테마를 선택하세요.</p>
            )}
            {!loading &&
                  ...
                  <div className="result-content">
                    <div className="result-image">
                      {result.mainImgNormal && (
                        <img src={result.mainImgNormal} alt={result.mainTitle} className="course-image" />
                      )}
                    </div>
                    <div className="result-details">
                      ...
                      <button
                        ...
                        onClick={() =>
                          handleImagePopup(result.mainImgNormal, result.itemCntnts, result.mainTitle, result.subTitle)
                        }
                      >
                        자세히
                      </button>
